...
FORCE_SUB_CHANNEL 1 = int(os.environ.get("FORCE_SUB_CHANNEL", "0"))
FORCE_SUB_GROUP = int(os.environ.get("FORCE_SUB_GROUP", "0"))
FORCE_SUB_CHANNEL 2 = int(os.environ.get("FORCE_SUB_CHANNEL", "0"))
FORCE_SUB_CHANNEL 3 = int(os.environ.get("FORCE_SUB_CHANNEL", "0"))
